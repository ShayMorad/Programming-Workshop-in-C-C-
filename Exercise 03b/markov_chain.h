...
#include <string.h>
#define ALLOCATION_ERROR_MASSAGE "Allocation failure: Failed to "\
"allocate new memory\n"
...
typedef void (*one_arg_func) (void *);
typedef int (*two_arg_func) (void *, void *);
typedef void *(*one_arg_clone_func) (void *);
typedef bool (*one_arg_bool) (void *);
/***************************/
...
typedef struct MarkovNode
{
    ...
    MarkovNodeFrequency *frequencies_list; //pointer to array
} MarkovNode;
